...
class CoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  def create_category_and_course(teacher=nil)
    category = create_category
    if teacher == nil
      return course = Course.create(category: category, name: "Test", description: "Test")
    else
  ...
  test "should get index" do
    category = create_category
    get category_courses_url(category.id)
